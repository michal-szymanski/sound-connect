/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: a7598baef01230734c70aaf4f4576867)
// Runtime types generated with workerd@1.20251008.0 2025-05-27 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ChatDurableObject" | "UserDurableObject";
	}
	interface Env {
		API_URL: string;
		CLIENT_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_URL" | "CLIENT_URL">> {}
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 59e8656637884029064597f05a1f179f)
// Runtime types generated with workerd@1.20251011.0 2025-10-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ChatDurableObject" | "UserDurableObject" | "NotificationsDurableObject";
	}
	interface Env {
		API_URL: "http://localhost:4000" | "https://sound-connect-api-production.michal-szymanski92.workers.dev";
		CLIENT_URL: "http://localhost:3000" | "https://sound-connect-web-production.michal-szymanski92.workers.dev";
		ADMIN_URL: "http://localhost:3001" | "https://sound-connect-admin-production.michal-szymanski92.workers.dev";
		BETTER_AUTH_URL: "http://localhost:4000/api/auth" | "https://sound-connect-api-production.michal-szymanski92.workers.dev/api/auth";
		R2_PUBLIC_URL: "https://pub-fe5ef299f3464b73b8c54144ff278eae.r2.dev";
		...
		SENTRY_DSN: string;
		ChatDO: DurableObjectNamespace<import("./src/server").ChatDurableObject>;
		UserDO: DurableObjectNamespace<import("./src/server").UserDurableObject>;
		NotificationsDO: DurableObjectNamespace<import("./src/server").NotificationsDurableObject>;
		ASSETS: R2Bucket;
		DB: D1Database;
		PostsQueue: Queue;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_URL" | "CLIENT_URL" | "ADMIN_URL" | "BETTER_AUTH_URL" | "R2_PUBLIC_URL" | "BETTER_AUTH_SECRET" | "MAPBOX_ACCESS_TOKEN" | "RESEND_API_KEY" | "SENTRY_AUTH_TOKEN" | "R2_ACCOUNT_ID" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_BUCKET_NAME" | "SENTRY_DSN">> {}
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: f707e92b2c85b1f8806a5068496448ea)
// Runtime types generated with workerd@1.20250508.0 2024-09-26 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		API_URL: string;
		CLIENT_URL: string;
		WS: DurableObjectNamespace<import("./src/server").WebSocketServer>;
		DB: D1Database;
	}
}

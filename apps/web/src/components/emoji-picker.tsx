...
export function EmojiPicker({ onEmojiSelect }: Props) {
    ...
    const recentEmojis = open ? getRecentEmojis() : [];
    ...
    return (
        <Popover open={open} onOpenChange={handleOpenChange}>
            ...
            <PopoverContent className="z-popover w-full max-w-[352px] p-0" style={{ width: '352px', height: '435px' }} align="start" onKeyDown={handleKeyDown}>
                                        ...
                                        {categories.map((category) => {
                                            ...
                                            return (
                                                <TabsContent
                                                    ...
                                                    value={category.id}
                                                    className="mt-0"
                                                    {...(debouncedQuery ? { forceMount: true } : {})}
                                                >
                                                    {debouncedQuery && (

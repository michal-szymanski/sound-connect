    ...
    return (
        <TabsPrimitive.Trigger
            ...
            className={cn(
                ...
                'hover:text-foreground hover:bg-muted/50 dark:hover:text-foreground dark:hover:bg-muted/50',
                ...
                'dark:data-[state=active]:bg-primary/15 dark:data-[state=active]:text-primary dark:data-[state=active]:border-primary/40',

    ...
    return (
        <Card className="border-border/40">
            <CardContent className="relative p-4">
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-56">
                            ...
                            <DropdownMenuItem asChild>
                                <Link to="/profile/$username" params={{ username: auth.user.username ?? auth.user.id.slice(0, 8) }}>
                ...
                <Link to="/profile/$username" params={{ username: auth.user.username ?? auth.user.id.slice(0, 8) }} className="group block">
                ...
                <div className="mt-3 flex items-center gap-4 text-sm">
                    <Link
                        to="/profile/$username"
                        params={{ username: auth.user.username ?? auth.user.id.slice(0, 8) }}

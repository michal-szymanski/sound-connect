...
export const NOTIFICATION_RETENTION_TIME = 30 * 24 * 60 * 60 * 1000; // 30 days in milliseconds
export const JWT_EXPIRATION_TIME_IN_SECONDS = 60 * 15; // 15 minutes in seconds
